...
| Beginner | [02 — Workflow syntax](beginner/02-workflow-syntax/README.md) | How does GitHub compile YAML, contexts, expressions, outputs, matrices, and containers into a run graph? | [Workflow lab](beginner/02-workflow-syntax/exercises/README.md) · [Starter](beginner/02-workflow-syntax/exercises/01-release-orchestration-starter.yml) · [Solution](beginner/02-workflow-syntax/solutions/01-release-orchestration.yml) · [Release fixture](beginner/02-workflow-syntax/release-fixture/) |
