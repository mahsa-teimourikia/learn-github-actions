...
test("the quiz has 21 questions in seven balanced categories", () => {
...
test("complete answer key earns 100 percent", () => { const selections = Object.fromEntries(questions.map((q) => [q.id, q.correct])); const result = gradeQuiz(questions, selections); assert.equal(result.percent, 100); assert.equal(result.correctCount, 21); });
