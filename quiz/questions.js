export const questions = [
  ...
  },
  {
    ...
    source: { label: "Workflow design — State and data movement", url: "curriculum/intermediate/01-workflow-design/README.md#state-and-data-movement" },
  },
  {
    id: "reuse-composite",
    category: "Reuse & Scale",
    ...
    source: { label: "Workflow design — Reuse boundaries", url: "curriculum/intermediate/01-workflow-design/README.md#reuse-boundaries-choose-the-smallest-honest-abstraction" },
  },
  {
    id: "design-selective-ci",
    category: "Workflow Design",
    prompt: "Which properties make an affected-service planner safe enough to skip work?",
    options: ["Propagate changes to transitive dependents", "Select all services for an unmapped code path", "Maintain labeled change cases and periodic full validation", "Treat documentation paths as affecting every service forever", "Record why each service was selected"],
    correct: [0, 1, 2, 4],
    explanation: "Safe selection follows dependencies, fails closed for unknown code, exposes reasons, and is continuously evaluated. Documentation can be explicitly classified without spending every service job.",
    source: { label: "Workflow design — Internal mechanics", url: "curriculum/intermediate/01-workflow-design/README.md#internal-mechanics-of-change-detection" },
  },
  {
    id: "design-cost-latency",
    category: "Workflow Design",
    prompt: "Which statements correctly compare workflow latency and runner consumption?",
    options: ["The critical path estimates idealized compute latency", "Parallel jobs still contribute to runner consumption", "max-parallel reduces the number of matrix jobs", "Queue and startup time add overhead beyond the DAG calculation", "Optimizing a non-critical job may save capacity without changing wall time"],
    correct: [0, 1, 3, 4],
    explanation: "Critical path and total work are different measures. max-parallel bounds simultaneous execution but does not remove jobs, while queueing and startup add observed latency.",
    source: { label: "Workflow design — Latency and capacity", url: "curriculum/intermediate/01-workflow-design/README.md#foundations-latency-capacity-and-selection-quality" },
  },
  {
    id: "design-required-gate",
    category: "Workflow Design",
    prompt: "How should a monorepo keep one trustworthy required check across dynamic fan-out?",
    options: ["Trigger a lightweight planner broadly", "Skip expensive jobs inside the graph", "Use a stable aggregate job that validates upstream conclusions", "Use always() and report success without inspecting needs", "Represent an empty plan explicitly"],
    correct: [0, 1, 2, 4],
    explanation: "The planner and aggregate check should exist for every relevant pull request. The gate must distinguish a deliberate empty plan from failed or unexpectedly skipped work.",
    source: { label: "Workflow design — Keep a required check present", url: "curriculum/intermediate/01-workflow-design/README.md#keep-a-required-check-present" },
  },
  {
    id: "deploy-artifact",
    category: "Deployment",
    ...
    source: { label: "Deployment patterns — Build once", url: "curriculum/intermediate/02-deployment-patterns/README.md#build-once-promote-many-times" },
  },
  {
